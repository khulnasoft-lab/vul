...
import (
	...
	"github.com/khulnasoft-lab/vul/pkg/sbom/cyclonedx"
	...
	}{
		{
			...
			inputReport: types.Report{
				...
				Results: types.Results{
					...
					{
						Target: "usr/local/bin/tfsecurity",
						Class:  types.ClassLangPkg,
				...
				Components: &[]cdx.Component{
					...
					},
					{
						...
						Properties: &[]cdx.Property{
							...
							{
								Name:  "khulnasoft-lab:vul:SrcRelease",
								Value: "93.el8",
							},
							{
			...
			want: &cdx.BOM{
				...
				Components: &[]cdx.Component{
					...
					},
					{
						...
						Properties: &[]cdx.Property{
							{
								Name:  "khulnasoft-lab:vul:FilePath",
					...
					},
					{
						...
						Properties: &[]cdx.Property{
							...
							{
								Name:  "khulnasoft-lab:vul:SrcEpoch",
								Value: "1",
							},
							{
								Name:  "khulnasoft-lab:vul:SrcName",
				...
				Dependencies: &[]cdx.Dependency{
					...
					},
					{
						...
						Dependencies: &[]string{
							...
							// Vul is unable to identify the direct OS packages as of today.
