...
import (
	...
	digest "github.com/khulnasoft-lab/vul/pkg/digest"
	types1 "github.com/khulnasoft-lab/vul/pkg/fanal/types"
		...
		case "Licenses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgTypes3(in, &v11)
		...
		case "CustomResources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes2(in, &v12)
	...
	if len(in.Packages) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v13, v14 := range in.Packages {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes(out, v14)
			}
			out.RawByte(']')
		}
	}
	if len(in.Vulnerabilities) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v15, v16 := range in.Vulnerabilities {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgTypes(out, v16)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.Misconfigurations) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v17, v18 := range in.Misconfigurations {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgTypes2(out, v18)
			}
			out.RawByte(']')
		}
	}
	if len(in.Secrets) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v19, v20 := range in.Secrets {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes1(out, v20)
			}
			out.RawByte(']')
		}
	}
	if len(in.Licenses) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v21, v22 := range in.Licenses {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgTypes3(out, v22)
			}
			out.RawByte(']')
		}
	}
	if len(in.CustomResources) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v23, v24 := range in.CustomResources {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes2(out, v24)
			}
			out.RawByte(']')
		}
	}
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgTypes3(in *jlexer.Lexer, out *types.DetectedLicense) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgTypes3(out *jwriter.Writer, in types.DetectedLicense) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes1(in *jlexer.Lexer, out *types1.SecretFinding) {
	...
	for !in.IsDelim('}') {
		...
		case "Code":
			easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes4(in, &out.Code)
		case "Match":
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes1(out *jwriter.Writer, in types1.SecretFinding) {
	...
	}
	{
		...
		out.RawString(prefix)
		easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes4(out, in.Code)
	}
	{
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes4(in *jlexer.Lexer, out *types1.Code) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Lines":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v25 types1.Line
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes5(in, &v25)
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes4(out *jwriter.Writer, in types1.Code) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Lines == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v26, v27 := range in.Lines {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes5(out, v27)
			}
			out.RawByte(']')
		}
	}
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes5(in *jlexer.Lexer, out *types1.Line) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes5(out *jwriter.Writer, in types1.Line) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgTypes2(in *jlexer.Lexer, out *types.DetectedMisconfiguration) {
	...
	for !in.IsDelim('}') {
		...
		case "Layer":
			easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes3(in, &out.Layer)
		case "CauseMetadata":
			easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes6(in, &out.CauseMetadata)
		case "Traces":
			if in.IsNull() {
				in.Skip()
				out.Traces = nil
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgTypes2(out *jwriter.Writer, in types.DetectedMisconfiguration) {
	...
	if true {
		...
		easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes6(out, in.CauseMetadata)
	}
	if len(in.Traces) != 0 {
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes6(in *jlexer.Lexer, out *types1.CauseMetadata) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "Occurrences":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes7(in, &v34)
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes6(out *jwriter.Writer, in types1.CauseMetadata) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Resource != "" {
	...
	if len(in.Occurrences) != 0 {
		...
		}
		{
			...
			for v35, v36 := range in.Occurrences {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes7(out, v36)
			}
			out.RawByte(']')
		}
	}
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes7(in *jlexer.Lexer, out *types1.Occurrence) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "Location":
			easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes8(in, &out.Location)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes7(out *jwriter.Writer, in types1.Occurrence) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Resource != "" {
	...
	}
	{
		...
		easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes8(out, in.Location)
	}
	out.RawByte('}')
}
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes8(in *jlexer.Lexer, out *types1.Location) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes8(out *jwriter.Writer, in types1.Location) {
	out.RawByte('{')
	first := true
	_ = first
	if in.StartLine != 0 {
		...
		case "CVSS":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					in.WantColon()
					var v40 types2.CVSS
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulDbPkgTypes1(in, &v40)
					(out.CVSS)[key] = v40
					in.WantComma()
				}
				in.Delim('}')
	...
	if len(in.CVSS) != 0 {
		...
		}
		{
			...
			for v47Name, v47Value := range in.CVSS {
				...
				out.RawByte(':')
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulDbPkgTypes1(out, v47Value)
			}
			out.RawByte('}')
		}
	}
	...
	for !in.IsDelim('}') {
		...
		case "BuildInfo":
			if in.IsNull() {
				...
				easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes9(in, out.BuildInfo)
			}
		case "Ref":
		...
		case "Locations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes8(in, &v52)
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes(out *jwriter.Writer, in types1.Package) {
	...
	if in.BuildInfo != nil {
		...
		easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes9(out, *in.BuildInfo)
	}
	if in.Ref != "" {
	...
	if len(in.Locations) != 0 {
		...
		}
		{
			...
			for v57, v58 := range in.Locations {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes8(out, v58)
			}
			out.RawByte(']')
		}
	}
...
func easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgFanalTypes9(in *jlexer.Lexer, out *types1.BuildInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgFanalTypes9(out *jwriter.Writer, in types1.BuildInfo) {
	out.RawByte('{')
	first := true
	_ = first
		...
		case "CustomResources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson6601e8cdDecodeGithubComkhulnasoft-labVulPkgModuleSerialize5(in, &v65)
	...
	_ = first
	{
		...
		if in.CustomResources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v66, v67 := range in.CustomResources {
				...
				easyjson6601e8cdEncodeGithubComkhulnasoft-labVulPkgModuleSerialize5(out, v67)
			}
			out.RawByte(']')
		}
	}
