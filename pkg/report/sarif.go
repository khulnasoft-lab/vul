...
const (
	...
	builtinRulesUrl = "https://github.com/khulnasoft-lab/vul/blob/main/pkg/fanal/secret/builtin-rules.go" // list all secrets
)
...
func (sw *SarifWriter) Write(report types.Report) error {
	...
	sw.run = sarif.NewRunWithInformationURI("Vul", "https://github.com/khulnasoft-lab/vul")
	sw.run.Tool.Driver.WithVersion(sw.Version)
	sw.run.Tool.Driver.WithFullName("Vul Vulnerability Scanner")
...
func toSarifLocations(locations []location, artifactLocation, locationMessage string) []*sarif.Location {
	...
	// e.g.https://github.com/khulnasoft-lab/go-dep-parser/pull/134#discussion_r985353240
