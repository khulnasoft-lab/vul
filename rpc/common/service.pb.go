...
type Vulnerability struct {
	...
	Severity             Severity               `protobuf:"varint,7,opt,name=severity,proto3,enum=vul.common.Severity" json:"severity,omitempty"`
...
func init() {
	proto.RegisterEnum("vul.common.Severity", Severity_name, Severity_value)
	proto.RegisterType((*OS)(nil), "vul.common.OS")
	proto.RegisterType((*PackageInfo)(nil), "vul.common.PackageInfo")
	proto.RegisterType((*Application)(nil), "vul.common.Application")
	proto.RegisterType((*Package)(nil), "vul.common.Package")
	proto.RegisterType((*Library)(nil), "vul.common.Library")
	proto.RegisterType((*Vulnerability)(nil), "vul.common.Vulnerability")
	proto.RegisterMapType((map[string]*CVSS)(nil), "vul.common.Vulnerability.CvssEntry")
	proto.RegisterType((*Layer)(nil), "vul.common.Layer")
	proto.RegisterType((*CVSS)(nil), "vul.common.CVSS")
}
