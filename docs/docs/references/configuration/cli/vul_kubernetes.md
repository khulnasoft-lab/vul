...
```
vul kubernetes [flags] { cluster | all | specific resources like kubectl. eg: pods, pod/NAME }
```
...
```
  ...
  -h, --help                              help for kubernetes
      ...
      --ignorefile string                 specify .vulignore file (default ".vulignore")
  ...
  -n, --namespace string                  specify a namespace to scan
      ...
      --node-collector-namespace string   specify the namespace in which the node-collector job should be deployed (default "vul-temp")
  ...
  -o, --output string                     output file name
      ...
      --policy-bundle-repository string   OCI registry URL to retrieve policy bundle from (default "ghcr.io/khulnasoft/defsec:0")
      ...
      --secret-config string              specify a path to config file for secret scanning (default "vul-secret.yaml")
