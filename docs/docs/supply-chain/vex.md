...
```
$ vul sbom vul.sbom.cdx --vex vul.vex.cdx
...
...
## OpenVEX
Vul also supports [OpenVEX][openvex] that is designed to be minimal, compliant, interoperable, and embeddable.
...
In Vul, [the Package URL (PURL)][purl] is used as the product identifier.
...
```
$ vul sbom debian11.spdx.json --vex debian11.openvex
...
